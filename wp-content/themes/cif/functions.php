 ...
 *
 * Semesterly archives can be found at {site_url}/{post_type}/{spring/fall}/year as of version 1.0
 * of functions-semesterly-posts/semesterly-posts.php.
 ...
 */
require_once 'functions-semesterly-posts/semesterly-posts.php';


/**
 * Registers custom shortcodes for use in the WordPress editor.
 *
 * See functions-shortcodes/registered-shortcodes.php and the files in the
 * functions-shortcodes directory for more information on what's available.
 */
 ...
 * Creating an Announcements post type
 * Creating a Board Minutes post type
 * Creating a Floor Minutes post type
 */
function cif_init() {
 ...
 * The default styles are: p,address,pre,h1,h2,h3,h4,h5,h6
 * 
